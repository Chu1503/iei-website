  ...
  return (
    <header className="sticky top-0 flex flex-col items-end justify-between sm:flex-row sm:w-auto sm:max-w-screen mx-auto h-auto sm:h-16 z-30 sm:bg-black sm:items-center">
      ...
      >
        ...
        <Link href="#events">
          <button className="herobutton cursor-pointer pb-1 sm:pb-0" onClick={closeNav}>Events</button>
        </Link>

        <Link href="#team">
          <button className="herobutton cursor-pointer pb-1 sm:pb-0" onClick={closeNav}>Team</button>
        </Link>
